...
public class SpScoreUtil {
    ...
    private static final String SCORE_LOAD = "score_load"; //读档次数
...
//    private static final String PARTNER_FY = "partner_fy"; //飞燕
    ...
    public void setScore(boolean isScore) {
        editor.putBoolean(SCORE_BOOLEAN, isScore);
        editor.commit();
    }

    // 读档次数
    public Integer getLoad() {
        return mSharedPreferences.getInt(SCORE_LOAD, 9);
    }

    public void setLoad(Integer load) {
        editor.putInt(SCORE_LOAD, load);
        editor.commit();
    }

    // 健康
    public Integer getHealthy() {
        return mSharedPreferences.getInt(SCORE_HEALTHY, 200);
    }

    public void setHealthy(Integer healthy) {
        editor.putInt(SCORE_HEALTHY, getHealthy() + healthy);
        editor.commit();
    }

    // 金钱
    public Integer getMoney() {
        return mSharedPreferences.getInt(SCORE_MONEY, 2000);
    }

    public void setMoney(Integer money) {
        editor.putInt(SCORE_MONEY, getMoney() + money);
        editor.commit();
    }

    // 能力
    public Integer getAbility() {
        return mSharedPreferences.getInt(SCORE_ABILITY, 100);
    }

    public void setAbility(Integer ability) {
        editor.putInt(SCORE_ABILITY, getAbility() + ability);
        editor.commit();
    }

    // 经验
    public Integer getExperience() {
        return mSharedPreferences.getInt(SCORE_EXPERIENCE, 100);
    }

    public void setExperience(Integer experience) {
        editor.putInt(SCORE_EXPERIENCE, getExperience() + experience);
        editor.commit();
    }

    // 快乐
    public Integer getHappy() {
        return mSharedPreferences.getInt(SCORE_HAPPY, 200);
    }

    public void setHappy(Integer happy) {
        editor.putInt(SCORE_HAPPY, getHappy() + happy);
        editor.commit();
    }

    // 道德
    public Integer getMorality() {
        return mSharedPreferences.getInt(SCORE_MORALITY, 200);
    }

    public void setMorality(Integer morality) {
        editor.putInt(SCORE_MORALITY, getMorality() + morality);
        editor.commit();
    }

    // 交际
    public Integer getCommunication() {
        return mSharedPreferences.getInt(SCORE_COMMUNICATION, 100);
    }

    public void setCommunication(Integer communication) {
        editor.putInt(SCORE_COMMUNICATION, getCommunication() + communication);
        editor.commit();
    }

    // 剩余月
    public Integer getMonth() {
        return mSharedPreferences.getInt(SCORE_MONTH, 96);
    }

    public void setMonth(Integer month) {
        editor.putInt(SCORE_MONTH, getMonth() + month);
        editor.commit();
    }

    // 剩余时间
    public Integer getTime() {
        return mSharedPreferences.getInt(SCORE_TIME, 230);
    }
    ...
    public void setTime(Integer time) {
        if (time.equals(0)) {
            ...
            editor.putInt(SCORE_TIME, getTime() + time);
        }
        editor.commit();
    }
    ...
    public void setStock(Integer stock) {
        editor.putInt(SCORE_STOCK, getStock() + stock);
        editor.commit();
    }
    ...
    public Integer getCareer() {
        return mSharedPreferences.getInt(SCORE_CAREER, 1);
    }

    public void setCareer(Integer career) {
        editor.putInt(SCORE_CAREER, getCareer() + career);
        editor.commit();
    }

    //爱情指数
    public Integer getLove() {
        return mSharedPreferences.getInt(SCORE_LOVE, 1);
    }

    public void setLove(Integer love) {
        editor.putInt(SCORE_LOVE, getLove() + love);
        editor.commit();
    }

    //随机股票指数
    public Integer getRandomStock() {
        return mSharedPreferences.getInt(SCORE_RANDOM_STOCK, 100);
    }
    ...
    public Integer getIndexHouse() {
        return mSharedPreferences.getInt(SCORE_INDEX_HOUSE, 100);
    }
    ...
    public Integer getIndexStock() {
        return mSharedPreferences.getInt(SCORE_INDEX_STOCK, 1700);
    }
    ...
    public Integer getPurity() {
        return mSharedPreferences.getInt(SCORE_PURITY, 100);
    }

    public void setPurity(Integer purity) {
        editor.putInt(SCORE_PURITY, getPurity() + purity);
        editor.commit();
    }

    // 月净收益
    public Integer getIncome() {
        return mSharedPreferences.getInt(SCORE_INCOME, 2200);
    }

    public void setIncome(Integer income) {
        editor.putInt(SCORE_INCOME, getIncome() + income);
        editor.commit();
    }
    ...
    public void setCommunicationMonthly(Integer communicationMonthly) {
        editor.putInt(SCORE_COMMUNICATION_MONTHLY, getCommunicationMonthly() + communicationMonthly);
        editor.commit();
    }

    // 月净快乐
    public Integer getHappyMonthly() {
        return mSharedPreferences.getInt(SCORE_HAPPY_MONTHLY, -2);
    }

    public void setHappyMonthly(Integer happyMonthly) {
        editor.putInt(SCORE_HAPPY_MONTHLY, getHappyMonthly() + happyMonthly);
        editor.commit();
    }
    ...
    public void setYd(Integer yd) {
        editor.putInt(GAME_YD, getYd() + yd);
        editor.commit();
    }
    ...
    public void setBl(Integer bl) {
        editor.putInt(GAME_BL, getBl() + bl);
        editor.commit();
    }
    ...
    public void setTs(Integer ts) {
        editor.putInt(GAME_TS, getTs() + ts);
        editor.commit();
    }
    ...
    public void setPy(Integer py) {
        editor.putInt(GAME_PY, getPy() + py);
        editor.commit();
    }
    ...
    public void setGj(Integer gj) {
        editor.putInt(GAME_GJ, getGj() + gj);
        editor.commit();
    }
    ...
    public void setCm(Integer cm) {
        editor.putInt(GAME_CM, getCm() + cm);
        editor.commit();
    }
    ...
    public void setCj(Integer cj) {
        editor.putInt(GAME_CJ, getCj() + cj);
        editor.commit();
    }
    ...
    public void setZj(Integer zj) {
        editor.putInt(GAME_ZJ, getZj() + zj);
        editor.commit();
    }
    ...
    public void setJb(Integer jb) {
        editor.putInt(GAME_JB, getJb() + jb);
        editor.commit();
    }
    ...
    public void setSw(Integer sw) {
        editor.putInt(GAME_SW, getSw() + sw);
        editor.commit();
    }
    ...
    public void setTy(Integer ty) {
        editor.putInt(GAME_TY, getTy() + ty);
        editor.commit();
    }
    ...
    public void setHj(Integer hj) {
        editor.putInt(GAME_HJ, getHj() + hj);
        editor.commit();
    }
...
//    }
    ...
    public void setPartnerSnTime(Integer partner_sn_time) {
        editor.putInt(PARTNER_SN_TIME, getPartnerSnTime() + partner_sn_time);
        editor.commit();
    }
